...
import com.herycs.user.dao.UserDao;
...
public class UserService {
	...
	public User findByPhone(String mobile) {return userDao.findByMobile(mobile);}
	...
	public User findById(String id) {
		...
		return Optional.ofNullable(userDao.findById(id)).map(item -> item.get()).orElse(null);
	}
	...
	public boolean checkCode(String code, String mobile) {
		String cacheCode = (String) redisTemplate.opsForValue().get("checkcode_" + mobile);
		logger.info("cacheCode:{}", cacheCode);
